...
<p>You will be entitled to a monthly stipend of <strong>{{stipend_formatted}}</strong> ({{stipend_words}}), payable at the end of each month, subject to applicable deductions.</p>
